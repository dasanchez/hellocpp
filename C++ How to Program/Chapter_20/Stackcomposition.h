...
// Template Stack class deinfition with ccomposed List object.
...
public:
    ...
    // push calls stackList obkect's insertAtFront member function
    void push(const STACKTYPE &data)
    {
        stackList.insertAtFront(data);
    } // end function push

    // pop calls stackList object's removeFrontFront member function
